...
def main():
    ...
    parser.add_argument('-opt', type=str, required=False, default='options/test/test_SRFBN_example.json', help='Path to options JSON file.')
    ...
    for bm, test_loader in zip(bm_names, test_loaders):
        ...
        for iter, batch in enumerate(test_loader):
            ...
            if use_wavelet:
                visuals = solver.get_current_visual_wv(need_HR=need_HR)
            else: 
