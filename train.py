...
def main():
    ...
    parser.add_argument('-opt', type=str, required=False, default='options/train/train_loss_SRFBN.json', help='Path to options JSON file.')
    ...
    for epoch in range(start_epoch, NUM_EPOCH + 1):
        ...
        for iter, batch in enumerate(val_loader):
            ...
            if use_wavelet:
                visuals = solver.get_current_visual_wv()
            else:
            ...
            if opt["save_image"]:
                solver.save_current_visual(epoch, iter, use_wavelet)
