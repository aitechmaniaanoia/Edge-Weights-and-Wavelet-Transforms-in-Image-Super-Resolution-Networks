...
def define_net(opt):
    ...
    elif which_model == 'SRFBN_WV':
        from .srfbn_wavelet_arch import SRFBN_wavelet
        net = SRFBN_wavelet(in_channels=opt['in_channels'], out_channels=opt['out_channels'],
                                  num_features=opt['num_features'], num_steps=opt['num_steps'], num_groups=opt['num_groups'],
                                  upscale_factor=opt['scale'])
                                  
    elif which_model == 'SRFBN_WL':
        from .srfbn_WL_arch import SRFBN_WL
        net = SRFBN_WL(in_channels=opt['in_channels'], out_channels=opt['out_channels'],
                                  num_features=opt['num_features'], num_steps=opt['num_steps'], num_groups=opt['num_groups'],
                                  upscale_factor=opt['scale'])
